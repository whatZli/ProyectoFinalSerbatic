							...
							<div class="card-block">
								<div class="pull-xs-right flipable">
									<div class="flipable-group m-2">
										...
										<a
											href="CabeceraPedidoBorrar?id_pedido=<c:out value="${pedido.id}" />"
											class="btn btn-danger remove-from-cart"> Devolver pedido
										</a>

										<a
											href="CabeceraPedidoVerDetalles?id_pedido=<c:out value="${pedido.id}" />"
											class="btn btn-primary remove-from-cart"> Ver pedido </a>
									</div>
								</div>
